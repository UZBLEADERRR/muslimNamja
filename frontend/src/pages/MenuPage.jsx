        ...
        <div className="animate-slide-up">
            ...
            {selectedFood && (
                <div style={{ position: 'fixed', inset: 0, background: 'var(--bg-primary)', zIndex: 999, display: 'flex', flexDirection: 'column', animation: 'slideUp 0.3s ease' }}>
                    ...
                    <button onClick={() => setSelectedFood(null)} style={{ position: 'absolute', top: 16, left: 16, width: 40, height: 40, borderRadius: '50%', background: 'rgba(0,0,0,0.5)', color: '#fff', border: 'none', fontSize: 20, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(10px)', zIndex: 10 }}>←</button>

                    {/* Everything scrolls together */}
                    <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
                        {/* Product Image */}
                        <div style={{ height: 200, background: `linear-gradient(135deg, #F5A62333, #F5A62366)`, display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', flexShrink: 0 }}>
                        ...
                        <div style={{ padding: '20px 20px 24px', flex: 1 }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 20 }}>
                                <div style={{ fontSize: 24, fontWeight: 900, color: 'var(--brand-accent)', fontFamily: "'Fraunces', serif" }}>₩{selectedFood.price?.toLocaleString()}</div>
